...
CREATE TABLE "TripsMetaDB"."Terminal"(
...
ALTER TABLE "TripsMetaDB"."Terminal" ADD CONSTRAINT "PK_Terminal" PRIMARY KEY ("TerminalId");

ALTER TABLE "TripsMetaDB"."Terminal" ALTER COLUMN "IsActive" SET DEFAULT false;

ALTER TABLE "TripsMetaDB"."Terminal" ADD CONSTRAINT "FK_Terminal_TerminalType" FOREIGN KEY ("TerminalTypeId") REFERENCES "TripsMetaDB"."TerminalType" ("TerminalTypeId") ON DELETE CASCADE ON UPDATE CASCADE;
