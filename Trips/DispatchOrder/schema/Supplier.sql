...
CREATE TABLE "DispatchOrder"."Supplier"(
...
ALTER TABLE "DispatchOrder"."Supplier" ADD CONSTRAINT "PK_Supplier" PRIMARY KEY("SupplierId");

ALTER TABLE "DispatchOrder"."Supplier" ALTER COLUMN "IsActive" SET DEFAULT false;
