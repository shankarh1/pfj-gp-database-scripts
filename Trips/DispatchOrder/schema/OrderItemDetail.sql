...
ALTER TABLE "DispatchOrder"."OrderItemDetail" ADD CONSTRAINT "FK_OrderItemDetail_OrderItem" FOREIGN KEY ("OrderItemId") REFERENCES "DispatchOrder"."OrderItem" ("OrderItemId")
ON DELETE CASCADE
ON UPDATE CASCADE;
