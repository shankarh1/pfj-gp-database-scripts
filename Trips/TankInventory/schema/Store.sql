...
CREATE TABLE "TankInventory"."Store"(
...
ALTER TABLE "TankInventory"."Store" ADD CONSTRAINT "PK_Store" PRIMARY KEY("StoreId");

ALTER TABLE "TankInventory"."Store" ALTER COLUMN "IsActive" SET DEFAULT false;
