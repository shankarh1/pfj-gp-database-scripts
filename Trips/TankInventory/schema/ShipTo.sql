...
CREATE TABLE "TankInventory"."ShipTo"(
...
ALTER TABLE "TankInventory"."ShipTo" ADD CONSTRAINT "PK_ShipTo" PRIMARY KEY("ShipToId");

ALTER TABLE "TankInventory"."ShipTo" ALTER COLUMN "IsActive" SET DEFAULT false;

ALTER TABLE "TankInventory"."ShipTo" ADD CONSTRAINT "FK_ShipTo_ShipToType" FOREIGN KEY("ShipToTypeId") REFERENCES "TankInventory"."ShipToType" ("ShipToTypeId")
ON UPDATE CASCADE
ON DELETE CASCADE;
